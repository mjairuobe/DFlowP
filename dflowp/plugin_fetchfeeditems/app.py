"""Plugin-Service für FetchFeedItems (underscore package)."""
...
PLUGIN_SERVICE_NAME = "plugin-fetchfeeditems"
...
app = FastAPI(title="DFlowP Plugin FetchFeedItems", version=PLUGIN_VERSION, lifespan=lifespan)
_plugin = FetchFeedItems()
...
def main() -> None:
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PLUGIN_PORT", "8101")))
