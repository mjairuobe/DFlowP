"""Plugin-Service für EmbedData (underscore package)."""
...
PLUGIN_NAME = "EmbedData"
PLUGIN_VERSION = os.environ.get("SOFTWARE_VERSION", "dev")
PLUGIN_SERVICE_NAME = "plugin-embeddata"
...
app = FastAPI(title="DFlowP Plugin EmbedData", version=PLUGIN_VERSION, lifespan=lifespan)
_plugin = EmbedData()
...
def main() -> None:
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PLUGIN_PORT", "8102")))
