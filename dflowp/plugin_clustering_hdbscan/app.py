"""Plugin-Service für Clustering_HDBSCAN."""
...
PLUGIN_NAME = "Clustering_HDBSCAN"
PLUGIN_VERSION = os.environ.get("SOFTWARE_VERSION", "dev")
PLUGIN_SERVICE_NAME = "plugin-clustering-hdbscan"
...
app = FastAPI(
    title="DFlowP Plugin Clustering_HDBSCAN",
    version=PLUGIN_VERSION,
    lifespan=lifespan,
)
_plugin = ClusteringHDBSCAN()
...
def main() -> None:
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PLUGIN_PORT", "8104")))
