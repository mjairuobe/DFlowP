"""Plugin-Service für TopicPrompting (OpenAI strukturierter Output)."""
...
from dflowp.plugin_topic_prompting.topic_prompting import TopicPrompting
...
PLUGIN_NAME = "TopicPrompting"
PLUGIN_VERSION = os.environ.get("SOFTWARE_VERSION", "dev")
PLUGIN_SERVICE_NAME = "plugin-topic-prompting"
...
app = FastAPI(
    title="DFlowP Plugin TopicPrompting",
    version=PLUGIN_VERSION,
    lifespan=lifespan,
)
_plugin = TopicPrompting()
...
def main() -> None:
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PLUGIN_PORT", "8105")))
