...
- **Daten**: Referenzen über IDs (z. B. `process_id`, Data-/Dataset-IDs); APIs exponieren oft Listen, Paginierung und CRUD-/Read-Pfade für Datasets, Data Items und Prozesse.
